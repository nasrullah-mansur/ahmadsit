                    ...
                    <div className="grid grid-col-1 lg:grid-cols-2 items-center gap-6 container mx-auto mt-[120px]">
                        <div className="order-2 lg:order-1">
                            ...
                            <p className="mt-3 text-lg">
                                আহমাদ’স আইটি ইনস্টিটিউট হল একটি আধুনিক প্রযুক্তি
                                প্রশিক্ষণ কেন্দ্র, যেখানে শিক্ষার্থীদের
                                বাস্তবভিত্তিক আইটি দক্ষতা উন্নয়নে সর্বোচ্চ
                                গুরুত্ব দেওয়া হয়। আমরা ওয়েব ডেভেলপমেন্ট, গ্রাফিক
                                ডিজাইন, ডিজিটাল মার্কেটিং, সফটওয়্যার
                                ডেভেলপমেন্টসহ বিভিন্ন আইটি কোর্স প্রদান করি।
                                দেশের প্রথম আবাসিক ব্যবস্থাপনায় আইটি প্রশিক্ষণের
                                সুবিধা দিয়ে আমরা শিক্ষার্থীদের হাতে-কলমে
                                অভিজ্ঞতা নিশ্চিত করি। আমাদের রয়েছে লাইভ ক্লাস,
                                ভিডিও রেকর্ড ক্লাস, আজীবন সহায়তা এবং ক্যারিয়ার
                                প্লেসমেন্ট সুবিধা। দক্ষ প্রশিক্ষক, আপডেটেড
                                কারিকুলাম ও বাস্তব অভিজ্ঞতার মাধ্যমে আমরা
                                শিক্ষার্থীদের প্রতিযোগিতামূলক আইটি খাতে দক্ষ করে
                                তুলতে প্রতিশ্রুতিবদ্ধ। আহমাদ’স আইটি ইনস্টিটিউট
                                আপনার স্বপ্ন পূরণের নির্ভরযোগ্য সহযোগী!
                            </p>
                        </div>
